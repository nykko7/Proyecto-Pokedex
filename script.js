...
function crearPokemon(id, nombre, tipo, evolucion, imagen){
  var cardHTML = `
    ...
    <div class="card-body">
      ...
      <p class="card-text mb-0 px-5"><strong>Tipo(s):</strong> ${tipo}</p>
      <p class="card-text mt-1 px-5"><strong>Evolución: </strong>${evolucion}</p>
    </div>`;
...
function crearPokemones(){
  for (var i=0; i<= 150; i++){
    ...
    crearPokemon(id, nombre, tipo, evolucion, imagen);
  }
}
